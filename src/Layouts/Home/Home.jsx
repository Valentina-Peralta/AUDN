                ...
                <NavLink to='/cupido'>
                    <div className="card">
                        ...
                        <div className="card-text">
                            ...
                            <p className='card-caption'>Tus artistas favoritos nunca van a dejarte con el corazón roto</p>
                        </div>
                    </div>
                </NavLink>
                <NavLink to='/contextual'>
                    <div className="card">
                        ...
                        <div className="card-text">
                            ...
                            <p className='card-caption'>Creamos la playlist perfecta para cualquier situación</p>
                        </div>
