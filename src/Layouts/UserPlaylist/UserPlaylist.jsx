    ...
    return (
        <div className="userPlContainer">
            ...
            <div className="plOptions">
                ...
                {playlist_name === 'Cupido Musical' || playlist_name === 'Música contextual' ?
                    <p
                        onClick={() => setCopyPlaylist(true)}
                        className="copy">Crear Copia</p> : null}
                {formattedHours > 0 ? <p>{formattedHours}:{formattedMin}:{formattedSec}</p> : <p>{min}:{sec}</p>}
            ...
            {copyPlaylist ? <div className="modal">
                <div className="pop-up">
                    ...
                    <input
                        ...
                        className="pop-up-input " type="text" />
                    <button
                        onClick={changePlaylistName}
                        className="btn-standard">¡Guardar playlist!</button>
                </div>
            </div> : null}
