        ...
        <div className='profile'>
            ...
            <NavLink to='/config'>
                <svg className='profile-config'
                    ...
                    <rect width="48" height="48" rx="24" fill="#FDFEFF" />
                    <path d="M24 13L20.7 16.3H16.3V20.7L13 24L16.3 27.3V31.7H20.7L24 35L27.3 31.7H31.7V27.3L35 24L31.7 20.7V16.3H27.3L24 13Z" stroke="#FF8E0A" strokeWidth="2" strokeLinejoin="round" />
            ...
            <NavBar />
>>>>>>> 059f8bff74827f693cc8e5b16cad698891dab784
        </div>
        <div className="profile-playlist">
          <div className="profile-playlist-img"></div>
          <p className="profile-playlist-name">Nombre de la playlist</p>
