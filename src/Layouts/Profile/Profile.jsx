    ...
    return (
        <div className='profile'>
            ...
            <svg className='profile-config'
                ...
                <path d="M24 27.3C24.8752 27.3 25.7146 26.9523 26.3335 26.3335C26.9523 25.7146 27.3 24.8752 27.3 24C27.3 23.1248 26.9523 22.2854 26.3335 21.6666C25.7146 21.0477 24.8752 20.7 24 20.7C23.1248 20.7 22.2854 21.0477 21.6666 21.6666C21.0477 22.2854 20.7 23.1248 20.7 24C20.7 24.8752 21.0477 25.7146 21.6666 26.3335C22.2854 26.9523 23.1248 27.3 24 27.3Z" stroke="#FF8E0A" stroke-width="2" stroke-linejoin="round" />
            </svg>
            ...
            <div className="profile-divider-container">
                ...
                <svg
                    ...
                    width="87" height="2" viewBox="0 0 87 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <line y1="1" x2="87" y2="1" stroke="#E4E6E8" stroke-width="2" />
                </svg>
